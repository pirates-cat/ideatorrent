...
<br />
	...
	<div style="font-size:25px; padding-left:10px"><?php echo t('Edit category !name', array("!name" => $data['category']->name)); ?></div>
	<br />

	<form method="post" action="">

	<fieldset class="entryfldset">
		<legend><b><?php echo t('Category name'); ?></b></legend>
		<div>
		<input type="textbox" name="cat_name" value="<?php echo htmlentities($data['category']->name); ?>" style="width:200px">
		</div>
		<span style="color:grey; font-size:x-small"><?php echo t('The name of the category to display.'); ?></span>
	</fieldset>

	<fieldset class="entryfldset">
		<legend><b><?php echo t('Category URL name'); ?></b></legend>
		<div>
		<input type="textbox" name="cat_urlname" value="<?php echo htmlentities($data['category']->url_name); ?>" style="width:200px">
		</div>
		<span style="color:grey; font-size:x-small"><?php echo t('The name of the category to use in URLs (e.g. http://localhost/my_category/).'); ?></span>
	</fieldset>

	<fieldset class="entryfldset">
		<legend><b><?php echo t('Ordering'); ?></b></legend>
		<div>
		<select name="cat_ordering">
		<?php for($i = -10; $i < 10; $i++) : ?>
		  <option value="<?php echo $i; ?>" <?php if($data['category']->ordering == $i) echo 'selected="selected"'; ?>><?php echo $i; ?></option>
		<?php endfor; ?>
		</select>
		</div>
	...
	<input type="submit" name="category_submit" value="<?php echo t('Save'); ?>" id="submitbutton" />
	</form>
